...
| --- | --- | --- |
| `BASIC_STORAGE_PATH` | Base directory for Docker persistent data. The derived data, database, and Caddy paths normally do not need to be changed individually. | `/opt` |
