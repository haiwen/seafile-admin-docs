...
Since Seafile 14.0, SeaSearch is the default search engine. For SeaSearch deployment and configuration details, refer to [Search with SeaSearch](../setup/use_seasearch.md). If you continue to use Elasticsearch, refer [Search with ElasticSearch](../setup/use_elasticsearch.md) for the details.
