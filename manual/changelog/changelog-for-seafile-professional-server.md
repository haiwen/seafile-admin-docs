...
### 13.0.24 (2026-06-09)
* [fix] Fix a file download issue of the Android client
...
* [fix] Fix security issues in Go fileserver. Thanks to [Francisco Garcia](http://github.com/PAX507) for reporting the issue.
...
* Improve support for Ceph rados backend
* [fix] Fix xlsx support if using SeaSearch search engine
...
* [fix] Fix performance issues of thumbnail-server based on a real-world heavy usage scenary (thanks to [yaoge123](https://github.com/yaoge123) for the contributed improvement code)
